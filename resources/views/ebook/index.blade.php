                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav ms-auto d-flex align-items-center gap-3">
                        <div class="nav-item d-flex align-items-center gap-2">
                            <a href="/dashboardpinjam" class="btn btn-outline-primary btn-sm">Buku</a>
                            <a href="/e-book" class="btn btn-outline-primary btn-sm active">E-Book</a>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12 mb-2 mb-lg-0">
                                <form class="d-flex" role="search" method="GET"
                                    action="{{ route('pinjamebook.index') }}">
                                    <input class="form-control" type="search" name="q"
                                        value="{{ request('q') }}" placeholder="Cari ebook..." aria-label="Search">
                                        ...
                                        <div class="card h-100 shadow-sm">
                                            ...
                                            <div style="width: 100%; height: 250px; overflow: hidden;">
                                                <img src="{{ asset('uploads/cover/' . $item->cover) }}"
                                                    alt="{{ $item->judul_ebook }}" class="card-img-top"
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <div class="mt-auto">
                                                    <h5 class="card-title text-truncate">{{ $item->judul_ebook }}</h5>
                                                    <div class="row g-2">

                                                        <div class="col-12">
                                                            <a href="{{ route('ebook.download', $item->id) }}"
                                ...
                                @empty
                                    <div class="col-12">
                                        <div class="card shadow-sm text-center p-4">
                                            <h5 class="mb-2">📚 Tidak ada Ebook ditemukan</h5>
                                            @if (request('q'))
                                                <p class="text-muted">
                                            ...
                                            @else
                                                <p class="text-muted">Belum ada data Ebook yang tersedia.</p>
                                            @endif
                                        </div>
                                    </div>
                                @endforelse
